...
// const STEP_FIELDS = {
//   1: ["fullName", "fatherName", "dob", "gender", "mobile", "email", "aadhaar", "pan", "category"],
//   2: ["permanentAddress", "currentAddress", "ward", "zone"],
//   3: ["vendorType", "businessCategory", "goodsType", "businessTiming", "yearsExperience"],
// };
...
//         {step === 3 && <Step3Business register={register} errors={errors} />}
//         {step === 4 && (
//           <Step4Documents documents={documents} setDocuments={setDocuments} />
//         )}
//         {step === 5 && (
//           <Step5Preview data={getValues()} documents={documents} goToStep={setStep} />
//         )}
...
//             </Button>
//           ) : (
//             <Button variant="success" icon={FiCheckCircle} onClick={handleSubmit}>
//               Submit Registration
//             </Button>
//           )}
//         </div>
...
//           key,
//           file ? { url: URL.createObjectURL(file), type: file.type } : null,
//         ])
//       ),
//     });
