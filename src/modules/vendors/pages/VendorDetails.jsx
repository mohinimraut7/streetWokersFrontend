...
//           Address Information
//         </h4>
//         <Item label="Permanent Address" value={address.permanentAddress} />
//         <Item label="Current Address" value={address.currentAddress} />
//         <Item label="Ward" value={address.ward} />
//         <Item label="Zone" value={address.zone} />
//       </div>
//     </div>
...
//       <div>
//         <Item label="Vendor Type" value={business.vendorType} />
//         <Item label="Business Category" value={business.businessCategory} />
//         <Item label="Goods Type" value={business.goodsType} />
//       </div>
//       <div>
//         <Item label="Business Timing" value={business.businessTiming} />
...
//                 <img src={doc.url} alt={label} className="h-full w-full object-cover" />
//               ) : (
//                 <span className="text-xs text-ink-400">{doc ? "Document" : "Not uploaded"}</span>
//               )}
//             </div>
//             <p className="px-3 py-2 text-xs font-semibold text-ink-700">{label}</p>
//           </div>
...
// ── Survey Geo Location — captured compulsorily by the Survey Officer during the field
//    survey, shown here on the vendor's profile once available. ──
export function SurveyLocationPanel({ vendor }) {
  const geo = vendor?.survey?.geoLocation;
  const hasGeo = geo && geo.lat !== undefined && geo.lat !== null && geo.lng !== undefined && geo.lng !== null;

  if (!hasGeo) {
    return (
      <div>
        <h4 className="mb-1 text-xs font-bold uppercase tracking-wide text-ink-400">Survey Location</h4>
        <p className="text-sm text-ink-400">Geo location will appear here once the field survey is completed.</p>
      </div>
    );
  }
  ...
  return (
    <div>
      <h4 className="mb-1 text-xs font-bold uppercase tracking-wide text-ink-400">Survey Location</h4>
      <Item label="Latitude" value={geo.lat} />
      <Item label="Longitude" value={geo.lng} />
      <a
