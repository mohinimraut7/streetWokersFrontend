...
// // 12-hour AM/PM string (e.g. "09:00" -> "09:00 AM") for display here —
// // matches the format that actually gets saved (see VendorRegistration.jsx).
...
//           <Row label="Working Address" value={data.workingAddress} />
